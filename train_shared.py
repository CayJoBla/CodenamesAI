...
from codenames.agents import AISharedAgent
...
def codenames(
    ...
    # Initialize the spymaster and operative agents
    agents = AISharedAgent(
    ...
    for i in tqdm.tqdm(range(num_games)):
        ...
        while not done:
            ...
            action = agents.get_action(env.state)
            ...
            while not done and team == env.state['turn'][0]:
                ...
                action = agents.get_action(obs_state)
                ...
                if do_train:
                    ...
                    agents.step(operative_reward, cn.Role.OPERATIVE)
                # print(f"Result: {info['result']}\n")
            ...
            if do_train:
                ...
                agents.step(spymaster_reward, cn.Role.SPYMASTER)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str, 
        default=None, 
        help="Path to a language model to use."
    )
    parser.add_argument(
        "--board_shape", 
        type=int, 
